...
st.set_page_config(
    page_title="FeedbackMind - Análise de Sentimento",
    page_icon="🧠",
    layout="wide"
)
...
def load_pipeline():
    ...
    model_path = Path(__file__).parent.parent / "models/pipeline_classificacao_sentimento.pkl"
    try:
...
def load_data():
    ...
    df = pd.read_csv("https://github.com/Jessicamsza/FeedbackMind/raw/refs/heads/main/data/olist_order_reviews_dataset.csv")
    return df
...
# LAYOUT DA APLICAÇÃO
st.title("🧠 FeedbackMind: Dashboard de Análise de Sentimento")
